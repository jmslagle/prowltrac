        ...
        try:
            ...
            for finding in findings:
                ...
                if finding.resource_type:
                    summary['by_service'][finding.resource_type] = summary['by_service'].get(finding.resource_type, 0) + 1
                
                # Count by cloud provider
                if finding.cloud_provider:
                    summary['by_provider'][finding.cloud_provider] = summary['by_provider'].get(finding.cloud_provider, 0) + 1
